...
class RedisProcessingGuardAdapterIT {
    ...
    void shouldAcquireOnlyOnceForSameTransactionId() {
        ...
        try {
            ...
            boolean first = adapter.acquire("tx-it-redis-001", Duration.ofMinutes(10));
            boolean second = adapter.acquire("tx-it-redis-001", Duration.ofMinutes(10));
