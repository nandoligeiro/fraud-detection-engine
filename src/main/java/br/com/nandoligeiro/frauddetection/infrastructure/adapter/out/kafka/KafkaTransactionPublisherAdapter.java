...
public class KafkaTransactionPublisherAdapter implements TransactionEventPublisherPort {
    ...
    public KafkaTransactionPublisherAdapter(KafkaTemplate<String, TransactionEventPayload> kafkaTemplate, TransactionEventMapper mapper, @Value("${fraud.kafka.topics.transaction-events}") String topic) {
